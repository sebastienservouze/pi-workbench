...
export function toolCallMetrics(input: string, output?: string): string[] {
  return [`Appel : ${input.length} caractères`, ...(output === undefined ? [] : [`Résultat : ${output.length} caractères`])]
}
